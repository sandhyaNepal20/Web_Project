...
import Checkout2 from "./pages/Checkout2.tsx";
...
const router=createBrowserRouter([
    ...
    {path:"/mycancellation",element:<Mycancellation />},
    ...
    // {path:"/checkout/addaddress?",element:<Addaddress />},
    {path:"/check_out",element:<Checkout2/>},
    {path:"/check_out/payment",element:<Paymentmethod/>},
